...
Actualización 20/09/2026: 0.2.0 Descargas y Servidores. 0.3.0 búsqueda. 0.4.0 selección múltiple y cancelar. 0.5.0 Incoming/tmp en Descargas/amule-modern. 0.6.0 bandeja, una instancia y reconexión EC. 0.7.0 compartidos. 0.8.0 Kad. El estado ejecutado está en STATUS.md.
